...
<p><strong>Organizational title: </strong>${show('organizational')}</p>
<p><strong>Your email: </strong><a href="">${show('email')}</a></p>
<p><strong>Your Phone: </strong>${show('phone')}</p>
<p><strong>Business/Organization's name: </strong>${show('organization')}</p>
<p><strong>Membership level: </strong>${show('membership')}</p>
<p><strong>Timestamp: </strong>${show('time')}</p>`
